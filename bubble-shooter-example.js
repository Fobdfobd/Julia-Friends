...
window.onload = function() {
   ...
   var bubbleImages = [];
var imageUrls = [
     "https://i.postimg.cc/L61PxV9z/julia.jpg",
    "https://i.postimg.cc/yk8bX6JP/claudia.png",
    "https://i.postimg.cc/zy92rnxt/laia.png",
    "https://i.postimg.cc/sB76Dv8V/laura.png",
    "https://i.postimg.cc/4m2F8CVT/marina.png",
    "https://i.postimg.cc/fV3qpHfS/marta.png",
    "https://i.postimg.cc/Kkb9KmSt/rivet2.png"
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const playAudio = () => {
        backgroundAudio.play().catch((error) => {
            ...
            // Esperar una interacción del usuario para iniciar la reproducción
